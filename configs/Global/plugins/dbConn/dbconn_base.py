...
#  wrapped in underscores (_) which contains all
#  core functionality.  This allows extension authors 
#  the option of leaving setup / logging / tear-down
#  from parent class in-tact, and only override the 
#  core functionality
#   
